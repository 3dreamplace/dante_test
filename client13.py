...
# Exibe a logo no header de forma responsiva
st.image("https://www.tutorialmaster.org/gpt/dante_header_V2.jpg", use_container_width=True)

# Título do aplicativo atualizado com fonte reduzida
st.markdown("<h1 style='font-size:32px;'>Assistente virtual para Registro de Imoveis</h1>", unsafe_allow_html=True)
